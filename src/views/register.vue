<template>
  <v-container fluid grid-list-xs class="pa-0">
    <v-row no-gutters class="justify-space-around">
      ...
      >
        <v-expand-transition class="pa-0"> </v-expand-transition>
          ...
          <v-stepper class="elevation-0" v-model="e1">
            <v-stepper-items class="px-0">
              <v-stepper-content step="1">
                <v-avatar size="100" color="#41b883" class="mb-10 elevation-1">
                  <v-icon size="70" color="white">{{
                    account_type == "" ? "mdi-plus" : "mdi-phone"
                  }}</v-icon>
                </v-avatar>
                <v-container grid-list-xs>
                  <v-row no-gutters class="justify-space-around">
                    <v-col cols="12" class="py-1 px-0 text-center">
                      <v-expand-transition class="pa-0">
                        <v-text-field
                  ...
                  <v-row no-gutters class="justify-space-around">
                    <v-col cols="12" class="py-1 px-0 text-center">
                      ...
                      <v-select
                        ...
                        color="#41b883"
                      ></v-select>
                      <v-btn color="#41b883" class="white" @click="e1 = 1" text>
                        <v-icon large>mdi-chevron-left</v-icon>BACK
                      </v-btn>
                      <v-btn color="#41b883" class="white" @click="e1 = 3" text>
                        NEXT<v-icon large>mdi-chevron-right</v-icon>
                      </v-btn>
                    </v-col>
                  </v-row>
                ...
                <v-container grid-list-xs>
                  <v-row no-gutters class="justify-space-around">
                    <v-col cols="12" class="py-1 px-0 text-center">
                      ...
                      ></v-text-field>
                      <v-btn color="#41b883" class="white" @click="e1 = 2" text>
                        <v-icon large>mdi-chevron-left</v-icon> BACK
                      </v-btn>
                      <v-btn color="#41b883" class="white" @click="e1 = 4" text>
                        NEXT <v-icon large>mdi-chevron-right</v-icon>
                      </v-btn>
                    </v-col>
                  </v-row>
              ...
              <v-stepper-content step="4">
                <v-avatar size="100" color="#41b883" class="mb-10 elevation-1">
                  <v-icon size="70" class="white--text" dark>mdi-image</v-icon>
                </v-avatar>
                <v-container grid-list-xs>
                  <v-row no-gutters class="justify-space-around">
                    <v-col cols="12" class="py-1 px-0 text-center">
                      ...
                      <v-btn color="#41b883" class="white" @click="e1 = 5" text>
                        NEXT <v-icon large>mdi-chevron-right</v-icon>
                      </v-btn>
                    </v-col>
                  </v-row>
    ...
    register() {
      ...
      if (account_type == "user") {
        if (
          ...
          Axios.post(
            "https://smartrex-server.herokuapp.com/api/v1/user/create",
            new_user
          )
            .then(res => {
              console.log(res);
              name = gender = age = b64 = password = city = state = re_password = mobile_1 = account_type = null;
        ...
        if (
          ...
          Axios.post(
            "https://smartrex-server.herokuapp.com/api/v1/doctor/create",
            new_doctor
          )
            .then(res => {
              console.log(res);
              name = gender = age = b64 = password = city = specialty = op_years = state = re_password = mobile_2 = mobile_1 = account_type = null;
              this.$store.state.notification.status = "success";
              this.$store.state.notification.message =
                "Account Created Successfully, Login to proceed";
              this.$store.state.loader = false;
        ...
        if (
          ...
          Axios.post(
            "https://smartrex-server.herokuapp.com/api/v1/hospital/create",
            new_hospital
          )
            .then(res => {
              console.log(res);
              name = b64 = password = city = address = specialty = op_years = state = re_password = mobile_2 = mobile_1 = account_type = null;
              this.$store.state.notification.status = "success";
              this.$store.state.notification.message =
                "Account Created Successfully, Login to proceed";
              this.$store.state.loader = false;
